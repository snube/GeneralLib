 ...
 **/
public class FrescoManeger {
    public static int screenWidth;

    private static final String PHOTO_FRESCO = "frescocache";

    private FrescoManeger() {
    }

    public static FrescoManeger getInstance() {
        return FrescoManegerHolder.holder;
    }

    private static class FrescoManegerHolder {
        private static FrescoManeger holder = new FrescoManeger();
    }
     ...
     *
     */
    public void init(final Context context, int cacheSizeInM, int padding) {
   ...
   /* public static void loadUrlInBlur(String url,SimpleDraweeView draweeView,
     ...
     * @param listener
     */
    public void loadUrl(String url, SimpleDraweeView draweeView, BasePostprocessor processor, int width, int height,
    ...
    public void loadFile(String file, SimpleDraweeView draweeView, BasePostprocessor processor, int width, int height,
                         BaseControllerListener listener) {
    ...
    public void loadFile(File file, SimpleDraweeView draweeView, BasePostprocessor processor, int width, int height,
                         BaseControllerListener listener) {
    ...
    public void loadRes(int resId, SimpleDraweeView draweeView, BasePostprocessor processor, int width, int height,
                        BaseControllerListener listener) {
    ...
    public void load(Uri uri, @NonNull SimpleDraweeView draweeView, @Nullable BasePostprocessor processor, int width, int height,
...
//         ALLog.e("picaso: width:"+v.getMeasuredWidth()+"--height:"+v.getMeasuredHeight());
    }
     ...
     */
    public void setCircle(SimpleDraweeView draweeView, @ColorInt int bgColor) {
     ...
     * @return
     */
    public boolean copyCacheFile(String url, File dir, String fileName) {
     ...
     * @return
     */
    public boolean copyCacheFile(String url, File path) {
        if (path == null) {
            return false;
        }
     ...
     * @return
     */
    public File copyCacheFileToDir(String url, File dir) {
        if (dir == null) {
            return null;
        }
        if (!dir.isDirectory()) {
     ...
     */
    public void download(final String url, Context context, final File dir, final DownloadListener listener) {
     ...
     * @param listener
     */
    public void getBitmap(String url, Context context, int width, int height, final BitmapListener listener) {
     ...
     * @param listener
     */
    public void getBitmapWithProcessor(@NonNull final String url, @NonNull Context context, @NonNull final int width, @NonNull final int height,
            ...
            protected void onNewResultImpl(Bitmap bitmap) {
                ...
                if (bitmap == null) {
                    ...
                    if ("gif".equalsIgnoreCase(getRealType(cacheFile))) {
                        ...
                        Bitmap target = BitmapUtils.compressBitmap(bitmapGif, true, width, height);//将bitmap压缩到指定宽高。
                        if (target != null) {
    ...
    public void loadUrlWithFace(final String url, final SimpleDraweeView draweeView) {
    ...
    public PointF getFaceFocusRatio(Bitmap bitmap) {
    ...
    private String getRealType(File file) {
