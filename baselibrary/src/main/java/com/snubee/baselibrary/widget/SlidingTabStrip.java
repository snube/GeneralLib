package com.snubee.baselibrary.widget;
...
public class SlidingTabStrip extends HorizontalScrollView {
    ...
    private TypedArray typedArrayTitles;
     ...
     * 关联ViewPager
     *
     * @param typedArrayTitles pager
     */
    public void setTypedArrayTitles(TypedArray typedArrayTitles) {
        this.typedArrayTitles = typedArrayTitles;
    ...
    private void notifyDataSetChanged() {
        ...
        tabCount = typedArrayTitles.length();
        for (int i = 0; i < tabCount; i++) {
            addTextTab(i, typedArrayTitles.getString(i));
        }
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (indicatorWrap) {
                    for (int i = 0; i < tabCount; i++) {
                        String s = typedArrayTitles.getString(i);
                        //计算所有tab的实际字体的宽
