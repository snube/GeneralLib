...
import com.snubee.baselibrary.banner.listener.OnBannerClickListener;
import com.snubee.baselibrary.banner.loader.ImageLoaderInterface;
import com.snubee.baselibrary.banner.view.BannerViewPager;
            ...
            if (listener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        listener.OnBannerClick(position, v.getTag());
                    }
                });
            }
            return view;
